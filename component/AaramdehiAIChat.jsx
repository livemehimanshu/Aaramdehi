...
export default function AaramdehiAIChat() {
  ...
  return <div className="fixed bottom-5 left-5 z-50">
    {open ? <div className="flex h-[min(34rem,calc(100vh-6rem))] w-[min(23rem,calc(100vw-2.5rem))] flex-col overflow-hidden rounded-2xl border border-amber-200 bg-white shadow-2xl">
