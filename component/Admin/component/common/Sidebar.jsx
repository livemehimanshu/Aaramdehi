...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuSections = [
    ...
    { 
      title: "Catalog", 
      items: [
        // Path updated to match App.jsx route
    ...
    { 
      title: "Sales & Orders", 
      items: [
        { name: 'Khata Book (Shops)', path: '/admin/shops', icon: Store },
        ...
        <nav className="flex-1 overflow-y-auto px-6 space-y-8 pb-8 custom-scrollbar">
          {menuSections.map((section, idx) => (
            <div key={idx} className="space-y-2">
              <p className="text-[9px] text-slate-500 font-bold tracking-[0.2em] uppercase px-4 mb-3">
                {section.title}
              </p>
