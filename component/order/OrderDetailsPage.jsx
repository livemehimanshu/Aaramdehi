                                ...
                                {order.orderItems.map((item, idx) => (
                                    <div key={idx} className="py-6 flex gap-6 items-center">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <Link to={`/product/${item.productSlug || item.productId}`} className="text-sm font-black text-gray-800 hover:text-blue-900 transition-colors line-clamp-1 uppercase">{item.name}</Link>
