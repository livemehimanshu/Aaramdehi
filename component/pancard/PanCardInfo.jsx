    ...
    return (
        <div className="flex-1 bg-white p-6 md:p-10 shadow-sm border border-gray-100 rounded-[30px] min-h-[600px]">
            ...
            <div className="max-w-md space-y-8">
                <div>
                    <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-1">Card Number</p>
                ...
                <div>
                    <p className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-1">Full Name (As on Card)</p>
                ...
                <div className="bg-gray-50 p-6 rounded-2xl border-2 border-dashed border-gray-100 group hover:bg-white hover:border-blue-900/20 transition-all">
                    <p className="text-[10px] text-gray-500 mb-4 font-black uppercase tracking-widest">Upload PAN Image (JPEG only)</p>
                ...
                <label className="flex items-start gap-3 text-[10px] font-bold text-gray-500 uppercase tracking-widest cursor-pointer leading-relaxed">
