  ...
  return (
    <>
      ...
      <div className={`${isStatic ? 'relative w-full h-full border border-gray-100 rounded-[30px] hidden md:flex' : 'fixed top-0 left-0 bottom-0 w-[85%] max-w-[320px] z-[1001] md:hidden transition-transform duration-300'} bg-white flex flex-col ${
        ...
        {/* Sidebar Header: User Info / Login Prompt */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              {user ? (
                ...
                <>
                  <p className="text-sm font-black uppercase tracking-tight truncate">Welcome Guest</p>
                  <p className="text-[10px] opacity-70 truncate lowercase">Login to view profile</p>
                </>
              )}
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto py-6 px-4 space-y-8">
          ...
          {/* Public Navigation Links (For Everyone) */}
          <div>
            <p className="px-3 text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-4">Navigation</p>
          ...
          {/* Section Group: Account Settings (Logged in only) */}
          {user && (
            <div>
          ...
          {/* Section Group: Payments (Logged in only) */}
          {user && (
            <div>
          ...
          {/* Section Group: My Stuff (Logged in only) */}
          {user && (
            <div>
